  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="hidden lg:block lg:w-1/2 relative">
        <img
          src="https://images.unsplash.com/photo-1762330474120-71b4057a8b40?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080"
          alt="Signup"
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-orange-500/90 to-orange-600/90 flex items-center justify-center">
          <div className="text-center text-white p-12">
            ...
            <p className="text-xl text-white/90">
              Get exclusive access to new arrivals, special offers, and more!
            </p>
          </div>
        </div>
      </div>
